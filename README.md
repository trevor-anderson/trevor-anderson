...
<!-- PROJECT SHIELDS GO HERE -->
  ...
  <div style="max-width: 50%; width: 50%; align-self: center; padding: 0 0rem; display: flex; flex-direction: row; justify-content: space-around; justify-items: space-around; align-content: center; align-items: center; background-color: red; ">
